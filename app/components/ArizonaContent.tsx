  ...
  return (
    <ThemeProvider>
      ...
      <main className="bg-white text-gray-900 flex flex-col">
        ...
        {/* ═══════ LONG FORM ═══════ */}
        <Section id="arizona-form" className="bg-white py-20">
        ...
        <section className="bg-black py-16 text-center px-6">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Bring Spavia to Arizona?
          </h2>
          <p className="text-gray-300 mb-8 max-w-lg mx-auto">
            Territories are limited. Secure your market in Scottsdale, Phoenix,
            or one of the other available Arizona locations today.
          </p>
          <a
            href="#arizona-form"
