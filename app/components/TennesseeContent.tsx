...
const jsonLd = {
  ...
  "@type": "WebPage",
  name: "Spavia Franchise Opportunities in Tennessee",
  description:
    "Spavia is expanding to Tennessee. Own a luxury day spa franchise in Nashville, Memphis, Knoxville, Chattanooga, Franklin, or Murfreesboro.",
...
const cities = ["Nashville", "Memphis", "Knoxville", "Chattanooga", "Franklin", "Murfreesboro"];

const marketStats = [
  {
    icon: Sun,
    stat: "7.1M+",
    label: "Tennessee Population",
  },
  {
    icon: TrendingUp,
    stat: "Top 15",
...
export default function TennesseeContent() {
  return (
    <ThemeProvider>
      <script
      ...
      <main className="bg-white text-gray-900 flex flex-col">
        <NavBar />
        <Breadcrumbs
          items={[{ label: "Franchise Opportunities" }, { label: "Tennessee" }]}
        />

        {/* ═══════ HERO ═══════ */}
        <section className="relative overflow-hidden pt-28 pb-20 text-center text-white px-4 sm:px-6 bg-gradient-to-br from-[#2e1a1a] via-[#3a1e2a] to-[#30100f]">
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            >
              Own a Spavia Day Spa Franchise in Tennessee
            </motion.h1>
            ...
            >
              Bring affordable luxury wellness to Nashville, Memphis, Knoxville, Chattanooga, Franklin, and Murfreesboro with a proven franchise model.
            </motion.p>
        ...
        {/* ═══════ SHORT FORM ═══════ */}
        <FranchiseIntroForm leadSource="tennessee_short" />

        {/* ═══════ WHY STATE ═══════ */}
        <section className="bg-gray-50 py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">
              Why Tennessee Is the Perfect Market for Spavia
            </h2>
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              Tennessee's rapidly growing metro areas, strong economy, and health-conscious residents make it an ideal market for a Spavia Day Spa franchise.
            </p>
        ...
        <section className="bg-white py-20 px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-10 max-w-2xl mx-auto">
              Be the first to bring Spavia to these high-demand Tennessee markets. All territories are currently available.
            </p>
        ...
        {/* ═══════ LONG FORM ═══════ */}
        <Section id="tennessee-form" className="bg-white py-20">
          <div className="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-md border border-gray-200">
            <h2 className="text-3xl font-bold text-center mb-2 text-gray-900">
              Request Tennessee Franchise Information
            </h2>
            <p className="text-center text-gray-700 mb-6">
              Learn more about opening a Spavia location in Tennessee.
            </p>
            <FranchiseLongForm leadSource="tennessee_long" />
          </div>
          <CallToAction />
        </Section>
        ...
        <section className="bg-black py-16 text-center px-6">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Bring Spavia to Tennessee?
          </h2>
          <p className="text-gray-300 mb-8 max-w-lg mx-auto">
            Territories are limited. Secure your market in Nashville, Knoxville, or one of the other available Tennessee locations today.
          </p>
          <a
            href="#tennessee-form"
