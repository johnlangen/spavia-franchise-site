...
const jsonLd = {
  ...
  "@type": "WebPage",
  name: "Spavia Franchise Opportunities in Georgia",
  description:
    "Spavia is expanding to Georgia. Own a luxury day spa franchise in Atlanta, Savannah, Alpharetta, Buckhead, Marietta, or Roswell.",
...
const cities = ["Atlanta", "Savannah", "Alpharetta", "Buckhead", "Marietta", "Roswell"];

const marketStats = [
  {
    icon: Sun,
    stat: "11.0M+",
    label: "Georgia Population",
  },
  {
    icon: TrendingUp,
    stat: "Top 10",
...
export default function GeorgiaContent() {
  return (
    <ThemeProvider>
      <script
      ...
      <main className="bg-white text-gray-900 flex flex-col">
        <NavBar />
        <Breadcrumbs
          items={[{ label: "Franchise Opportunities" }, { label: "Georgia" }]}
        />
        ...
        <section className="relative overflow-hidden pt-28 pb-20 text-center text-white px-4 sm:px-6 bg-gradient-to-br from-[#1a2e2e] via-[#163e3e] to-[#0f4040]">
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            >
              Own a Spavia Day Spa Franchise in Georgia
            </motion.h1>
            ...
            >
              Bring affordable luxury wellness to Atlanta, Savannah, Alpharetta, Buckhead, Marietta, and Roswell with a proven franchise model.
            </motion.p>
        ...
        {/* ═══════ SHORT FORM ═══════ */}
        <FranchiseIntroForm leadSource="georgia_short" />

        {/* ═══════ WHY STATE ═══════ */}
        <section className="bg-gray-50 py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">
              Why Georgia Is the Perfect Market for Spavia
            </h2>
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              Georgia's massive metro Atlanta market, growing affluent suburbs, and strong wellness demand make it an ideal market for a Spavia Day Spa franchise.
            </p>
        ...
        <section className="bg-white py-20 px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-10 max-w-2xl mx-auto">
              Be the first to bring Spavia to these high-demand Georgia markets. All territories are currently available.
            </p>
        ...
        <Section id="georgia-form" className="bg-white py-20">
          <div className="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-md border border-gray-200">
            ...
            <p className="text-center text-gray-700 mb-6">
              Learn more about opening a Spavia location in Georgia.
            </p>
