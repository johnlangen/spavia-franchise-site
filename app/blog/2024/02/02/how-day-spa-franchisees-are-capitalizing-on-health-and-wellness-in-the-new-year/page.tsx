...
export default function Page() {
  return (
    <>
      <NavBar />
      <Breadcrumbs items={[{ label: "Blog", href: "/blog" }, { label: "How Day Spa Franchisees Are Capitalizing on Health and We..." }]} />
      <script
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <ul className="space-y-3">
              {getRelatedPosts("/blog/2024/02/02/how-day-spa-franchisees-are-capitalizing-on-health-and-wellness-in-the-new-year").map((rp) => (
                <li key={rp.href}>
