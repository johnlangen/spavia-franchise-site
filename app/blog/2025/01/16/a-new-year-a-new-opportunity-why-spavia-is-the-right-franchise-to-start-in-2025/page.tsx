...
export default function Page() {
  return (
    <>
      <NavBar />
      <Breadcrumbs items={[{ label: "Blog", href: "/blog" }, { label: "A New Year, A New Opportunity: Why Spavia is the Right Fr..." }]} />
      <script
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <ul className="space-y-3">
              {getRelatedPosts("/blog/2025/01/16/a-new-year-a-new-opportunity-why-spavia-is-the-right-franchise-to-start-in-2025").map((rp) => (
                <li key={rp.href}>
